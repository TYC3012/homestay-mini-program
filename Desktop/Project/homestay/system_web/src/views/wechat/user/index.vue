  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="民宿名字" prop="avatar">
          <el-input v-model="form.avatar" placeholder="请输入民宿名字" />
        </el-form-item>
...
<script>
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/wechat/user";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('wechat/user/export', {
        ...this.queryParams
